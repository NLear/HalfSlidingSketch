...
#ifndef SLIDING_SKETCH_MASTER_HASH_CLASS_H
#define SLIDING_SKETCH_MASTER_HASH_CLASS_H
...
unsigned int Hash(const unsigned char *str, int num, int length) {
    switch (num) {
        ...
        case 1:
            return BOB4(str, length);
        case 2:
            return BOB2(str, length);
        case 3:
            return DJBHash(str, length);
        case 4:
            return SDBM(str, length);
        case 5:
            return OAAT(str, length);
        case 6:
            return BOB3(str, length);
        case 7:
            return FNV32(str, length);
        case 8:
...
#endif //SLIDING_SKETCH_MASTER_HASH_CLASS_H
